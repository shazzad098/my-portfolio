        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          >
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              Hello! I'm <span className="font-semibold text-blue-600 dark:text-blue-400">Shazzad Haque Prince</span>, a passionate and detail-oriented Web Developer with expertise in creating intuitive, dynamic, and user-friendly web experiences.
            </motion.p>
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              My expertise lies in full-stack development, where I leverage modern technologies like <span className="font-medium text-blue-600 dark:text-blue-400">React</span>, <span className="font-medium text-blue-600 dark:text-blue-400">Next.js</span>, <span className="font-medium text-blue-600 dark:text-blue-400">Tailwind CSS</span>, and <span className="font-medium text-blue-600 dark:text-blue-400">Node.js</span> to build high-performance, responsive applications from concept to deployment.
            </motion.p>
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              I thrive on turning complex problems into elegant, efficient solutions and believe in continuous learning to stay ahead in the ever-evolving landscape of web technology. I'm currently seeking new opportunities to apply my skills in challenging and collaborative environments.
            </motion.p>
        ...
        >
          {[
            ...
            >
              ...
              <h4 className="font-medium text-gray-800 dark:text-white text-sm">{item.label}</h4>
            </div>
          ))}
        </motion.div>
      </div>
