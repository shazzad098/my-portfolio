...
import { FiSend, FiMail, FiMapPin, FiPhone, FiLinkedin, FiGithub } from 'react-icons/fi';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          >
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              I'm currently available for new opportunities and interesting projects. Feel free to reach out if you'd like to work together or just say hello!
            </motion.p>
            ...
            <motion.div className="space-y-6" variants={itemVariants}>
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">shazzad920@gmail.com</p>
                </div>
              </div>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl p-8 shadow-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <motion.div variants={itemVariants}>
                  <label htmlFor="name" className="block mb-2 font-medium text-gray-800 dark:text-white">Name</label>
                  <input 
                    type="text" 
                    id="name" 
                    name="name" 
                ...
                <motion.div variants={itemVariants}>
                  <label htmlFor="email" className="block mb-2 font-medium text-gray-800 dark:text-white">Email</label>
                  <input 
                    type="email" 
                    id="email" 
                    name="email" 
                ...
                <motion.div variants={itemVariants}>
                  <label htmlFor="message" className="block mb-2 font-medium text-gray-800 dark:text-white">Message</label>
                  <textarea 
                    id="message" 
                    name="message" 
                    rows={5} 
